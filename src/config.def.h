...
//    NAME    TIMEOUT  FUNC      TRESHOLD  MAXLEN  SEPARATOR
    { "mpd",        5, get_mpd,        -1,     40,       " "},
    { "caffeine",   2, get_caffeine,   -1,     40,       " "},
    { "http",      30, get_http,       -1,     -1,       " "},
    { "battery",   30, get_battery,    10,     10,       " "},
    { "volume",     3, get_volume,     -1,     10,       " "},
    { "maildirs",  15, get_maildirs,   -1,     40,       " "},
    { "network",    3, get_network,    60,     -1,       " "},
    { "datetime",   5, get_datetime,   -1,     -1,       " "}
};
